...
#     script_name = "physical_coverage"
#     print("Sintax: " + script_name + " samfile genomelength")
#     sys.exit()
#
# elif len(sys.argv) == 2:
#     sys.exit("Sintax: One parameter [samfile or genomelength] is missing")
#
# elif len(sys.argv) > 2:
...
for line in sam_file:
    ...
    # get the last two number of flag
    interesting_flag = flag[-2:]
